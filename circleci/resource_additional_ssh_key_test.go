...
func TestAccAdditionalSSHKeyResource(t *testing.T) {
	testCases := map[string]func(*testing.T){
		...
		"RSA key creates and deletes as expected": func(t *testing.T) {
			resource.Test(t, resource.TestCase{
				PreCheck: func() {
					assureAdditionalSSHKeyDoesNotExist(t, "gh/StephenWithPH/terraform-provider-circleci-acceptance-test-target", "b3:fb:7a:ff:ec:7f:8c:7c:3b:1b:24:c1:42:c6:5d:a1", "FOO")
				},
				ProviderFactories: testAccProviders,
				Steps: []resource.TestStep{
					{
            ...
            `,
						Check: resource.ComposeTestCheckFunc(
							...
							resource.TestCheckResourceAttr("circleci_additional_ssh_key.test", "id", "gh/StephenWithPH/terraform-provider-circleci-acceptance-test-target/b3:fb:7a:ff:ec:7f:8c:7c:3b:1b:24:c1:42:c6:5d:a1"),
		...
		"ECDSA key creates and deletes as expected": func(t *testing.T) {
			resource.Test(t, resource.TestCase{
				PreCheck: func() {
					assureAdditionalSSHKeyDoesNotExist(t, "gh/StephenWithPH/terraform-provider-circleci-acceptance-test-target", "aa:c6:6d:1b:4f:23:4d:9b:a7:ea:f0:ea:d7:ee:ad:45", "FOO")
				},
				ProviderFactories: testAccProviders,
				Steps: []resource.TestStep{
					{
            ...
            `,
						Check: resource.ComposeTestCheckFunc(
							// the fingerprint is of the public key
							resource.TestCheckResourceAttr("circleci_additional_ssh_key.test", "id", "gh/StephenWithPH/terraform-provider-circleci-acceptance-test-target/aa:c6:6d:1b:4f:23:4d:9b:a7:ea:f0:ea:d7:ee:ad:45"),
