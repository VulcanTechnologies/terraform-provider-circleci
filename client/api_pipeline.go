...
@return Pipeline
*/
func (a *PipelineApiService) GetPipelineByNumber(ctx _context.Context, projectSlug string, pipelineNumber interface{}) (Pipeline, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param "OrgSlug" (optional.String) -  Org slug in the form `vcs-slug/org-name`
 * @param "PageToken" (optional.String) -  A token to retrieve the next page of results.
 * @param "Mine" (optional.Bool) -  Only include entries created by your user.
@return PipelineListResponse
*/
func (a *PipelineApiService) ListPipelines(ctx _context.Context, localVarOptionals *ListPipelinesOpts) (PipelineListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *PipelineApiService) TriggerPipeline(ctx _context.Context, projectSlug string, localVarOptionals *TriggerPipelineOpts) (PipelineCreation, *_nethttp.Response, error) {
	var (
